(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("url"), require("stream"), require("http"), require("buffer"), require("https"), require("zlib"), require("string_decoder"), require("util"));
	else if(typeof define === 'function' && define.amd)
		define("QiwiBillsApi", ["url", "stream", "http", "buffer", "https", "zlib", "string_decoder", "util"], factory);
	else if(typeof exports === 'object')
		exports["QiwiBillsApi"] = factory(require("url"), require("stream"), require("http"), require("buffer"), require("https"), require("zlib"), require("string_decoder"), require("util"));
	else
		root["QiwiBillsApi"] = factory(root["url"], root["stream"], root["http"], root["buffer"], root["https"], root["zlib"], root["string_decoder"], root["util"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_6__, __WEBPACK_EXTERNAL_MODULE_9__, __WEBPACK_EXTERNAL_MODULE_14__, __WEBPACK_EXTERNAL_MODULE_15__, __WEBPACK_EXTERNAL_MODULE_21__, __WEBPACK_EXTERNAL_MODULE_38__) {
...
var parse_url = __webpack_require__(0).parse;
var resolve_url = __webpack_require__(0).resolve;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__QiwiBillsApi_js__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__oldQiwiBillsApi_js__ = __webpack_require__(41);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_node_fetch__ = __webpack_require__(5);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_url__ = __webpack_require__(0);
...
class QiwiBillsApi {
    ...
    async _requestBuilder({ url, method, body = null }) {
        ...
        try {
            const data = await __WEBPACK_IMPORTED_MODULE_0_node_fetch___default.a(`https://api.qiwi.com/api/v3/prv/bills/${url}`, {
                method,
                headers,
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(3).concat(__webpack_require__(7)) },
    },
    'xgbk': 'gbk',
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(8).concat(__webpack_require__(33)) },
...
class oldQiwiBillsApi {
    ...
    async _requestBuilder({ url, method, body = null }) {
        ...
        try {
            const data = await __WEBPACK_IMPORTED_MODULE_0_node_fetch___default.a(`https://api.qiwi.com/api/v2/prv/${this._prvId}/bills/${url}`, {
                method,
                headers,
                body: new __WEBPACK_IMPORTED_MODULE_1_url__["URLSearchParams"](body)
            });
