(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("QiwiBillsApi", [], factory);
	else if(typeof exports === 'object')
		exports["QiwiBillsApi"] = factory();
	else
		root["QiwiBillsApi"] = factory();
})(this, function() {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__QiwiBillsApi_js__ = __webpack_require__(3);


/* harmony default export */ __webpack_exports__["default"] = (__WEBPACK_IMPORTED_MODULE_0__QiwiBillsApi_js__["a" /* default */]);
...
class QiwiBillsApi {
    ...
    async _requestBuilder({ url, method, body = null }) {
        ...
        try {
            const data = await fetch(/*`//api.qiwi.com/api/v3/prv/bills/${url}`*/'//api.github.com/users/mralexgray/repos', {
                method,
                headers,
                body
            });
