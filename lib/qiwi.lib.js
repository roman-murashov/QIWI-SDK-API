(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("RestV3", [], factory);
	else if(typeof exports === 'object')
		exports["RestV3"] = factory();
	else
		root["RestV3"] = factory();
})(this, function() {
...
var _RestV = __webpack_require__(299);

var _RestV2 = _interopRequireDefault(_RestV);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _RestV2.default;
...
var RestV3 = function () {
    ...
    _createClass(RestV3, [{
        ...
        key: 'requestBuilder',
        value: function requestBuilder(_ref) {
            var url = _ref.url,
                method = _ref.method,
                _ref$body = _ref.body,
        ...
        key: 'billing',
        value: function billing(bill_id) {
        ...
        value: function requestBillStatus(bill_id) {
        ...
        key: 'cancellingUnpaidBill',
        value: function cancellingUnpaidBill(bill_id) {
            var options = {
                url: this._url + '/' + bill_id,
                method: 'PATCH',
                body: JSON.stringify({
        ...
        key: 'refundByPaidBill',
        value: function refundByPaidBill(bill_id, refund_id) {
            var amount = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
        ...
        key: 'refundStatus',
        value: function refundStatus(bill_id, refund_id) {
            var options = {
                url: this._url + '/' + bill_id + '/refund/' + refund_id,
                method: 'GET'
            };
